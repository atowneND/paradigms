class Employee:
    ...
    def giveRaise(self):
        self.salary = self.salary*(1.0+(Employee.default_salary_inflator*1.0)/100.)
...
class EmployeeA(Employee):
    ...
    def giveRaise(self):
        self.salary = self.salary*(1.0+(Employee.default_salary_inflator*EmployeeA.inflator_A*1.0)/100.)
...
class EmployeeC(Employee):
    ...
    def giveRaise(self):
        self.salary = self.salary*(1.0+(Employee.default_salary_inflator*EmployeeC.inflator_C*1.0)/100.)
...
class EmployeeAB(EmployeeA):
    ...
    def giveRaise(self):
        self.salary = self.salary*(1.0+(Employee.default_salary_inflator*EmployeeA.inflator_A*EmployeeAB.inflator_B*1.0)/100.)
